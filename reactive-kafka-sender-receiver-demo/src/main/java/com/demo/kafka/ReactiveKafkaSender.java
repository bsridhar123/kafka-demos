...
public class ReactiveKafkaSender {
    ...
    private static final Logger log = LoggerFactory.getLogger(ReactiveKafkaSender.class.getName());

    private static final String BOOTSTRAP_SERVERS = "localhost:9092";
    private static final String TOPIC = "Sritopic";

    private final KafkaSender<Integer, String> sender;
    private final SimpleDateFormat dateFormat;

    public ReactiveKafkaSender(String bootstrapServers) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ReactiveKafkaSender producer = new ReactiveKafkaSender(BOOTSTRAP_SERVERS);
